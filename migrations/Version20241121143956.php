 ...
 */
final class Version20241121143956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id SERIAL NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(60) DEFAULT NULL, surnames VARCHAR(80) DEFAULT NULL, age INT DEFAULT NULL, birthdate DATE DEFAULT NULL, username VARCHAR(50) NOT NULL, is_verified BOOLEAN NOT NULL, PRIMARY KEY(id))');
